 ...
 Host: localhost:8889
 Generation Time: Apr 17, 2022 at 01:28 PM
...
(32, 'Testing Group', '2016321201588', 11, '0', '0', '0', '0');
...
(12, '2016321201588', 18, 'Joined'),
(11, '2016321201588', 19, 'Joined');
...
INSERT INTO `lab_reports_table` (`Lab_Report_ID`, `Course_ID`, `Posted_Date`, `Deadline`, `Instructions`, `Title`, `Attachment_link_1`, `Attachment_link_2`, `Attachment_link_3`, `Attachment_link_4`, `Marks`, `Type`, `status`) VALUES
(1, 10, '20190111 16:52', '20190211 17:00', 'Description of the lab....', 'Reading 1', '700IMPORTANT WORDS.txt', '', '', '', '4', 'Individual', 0),
(2, 10, '20190117 11:12', '20190125 23:59', 'Read this paper http://sunnyday.mit.edu/16.355/budgendavid.pdf', 'Reading 2', '586LRRTestcaseS.pdf', '', '', '', '6', 'Individual', 0),
(3, 12, '20200405 02:48', '20200412 ', 'Do this assignment in time for testing', 'First Assignment Testing', '', '', '', '', '3', 'Group', 0),
(4, 12, '20200405 05:36', '20200406 ', 'We are testing to see if the instructor can be able to modify the work', 'Second Assignment Testing', '', '', '', '', '3', 'Individual', 0),
(5, 12, '20200405 05:51', '20200408 ', 'ASQDASDASCDD', 'Third Assignment Testingas', '', '', '', '', '3', 'Individual', 0),
(6, 0, '20200406 11:02', '20200410 10:00', 'random', 'random', '', '', '', '', '3', 'Individual', 0),
(11, 11, '20220417 20:42:20', '20220419 ', 'let build a software asap', 'Software Eng Project', '', '', '', '', '10', 'Individual', 1),
(12, 11, '20220417 21:18:21', '20220430 13:29', 'testing deadline', 'Testing deadline', '/Testing deadline/backimgcanada.jpg', '/Testing deadline/backimgcanada.jpg', '/Testing deadline/backimgcanada.jpg', '/Testing deadline/backimgcanada.jpg', '10', 'Individual', 0);
...
(1, '20190117 00:00:00', 1, '201825800050', 0, 'Reading list.txt', '', '', '', '', 5, 'Marked', 'Reading 1 submission', 'Public', ''),
(5, '20190121 08:31:00', 2, '201825800050', 0, 'Trial Balance.txt', '  @20190121 09:35 : Sorry I missed some details from your report', 'Boorka.jpg', '', '', 6, 'Marked', 'Submission x', 'Private', ''),
(30, '20200406 23:18:00', 3, '0', 31, '/2016321201502/First Assignment Testing/UR Diagram.pdf', '<br>@20200406 23:19 : ', '', '', '', 3, 'Marked', 'First Assignment Testing', 'Private', ''),
(33, '20220417 21:08:07', 11, '2016321201588', 0, '/2016321201588/P.M20192019/Software Eng Project/day1.png', '', '', '', '', NULL, 'Pending', 'still testing ', 'Private', '');
...
(12, 'mehdi@qq.com', '123', '', 'Elmehdi Houzi', 'Student', '201825800054', 'LJ7951632', 'Active'),
...
(19, 'mikeannanhallo@gmail.com', '12345', '$2y$10$Atc41HR9gxBAwRALV5GkTOa1hJI3iNtWP/RoIKuwzWdEqC.fbyorW', '11', 'Student', '2016321201588', '', 'Active');
...
ALTER TABLE `course_groups_table`
  MODIFY `Course_Group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
ALTER TABLE `lab_reports_table`
  MODIFY `Lab_Report_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;


 AUTO_INCREMENT for table `lab_report_submissions`

ALTER TABLE `lab_report_submissions`
  MODIFY `Submission_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
